const CACHE_VERSION = '1.7.52';

const BASE_CACHE_FILES = [
    'https://ecommerce.mindconsulting.com.br/wp-content/plugins/pwa-for-wp/images/logo.png',
'https://ecommerce.mindconsulting.com.br/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',
'https://ecommerce.mindconsulting.com.br/wp-content/plugins/pwa-for-wp/images/logo-512x512.png',

];

const OFFLINE_CACHE_FILES = [
     'https://ecommerce.mindconsulting.com.br/',
];
...
const OFFLINE_PAGE = 'https://ecommerce.mindconsulting.com.br/';
const NOT_FOUND_PAGE = 'https://ecommerce.mindconsulting.com.br/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('https://ecommerce.mindconsulting.com.br//wp-admin/');
//    },
];
