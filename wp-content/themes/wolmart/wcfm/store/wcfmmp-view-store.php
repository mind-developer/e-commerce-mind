...
@media screen and (max-width: 480px) {
	#wcfmmp-store .header_right {
		background: <?php echo wolmart_escaped( $mob_wcfmmp_header_background_color ); ?>;
	}
}
</style>		
<?php wolmart_filter_inline_css( ob_get_clean() ); ?>
<?php //do_action( 'woocommerce_before_main_content' ); ?>
<?php echo '<div id="primary" class="content-area">'; ?>
<?php do_action( 'wcfmmp_before_store', $store_user->data, $store_info ); ?>

<div id="wcfmmp-store" class="wcfmmp-single-store-holder <?php echo wolmart_escaped( $wcfm_store_wrapper_class ); ?>">
