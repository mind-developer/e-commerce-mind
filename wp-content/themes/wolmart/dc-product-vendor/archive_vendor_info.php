			...
			<div class="vendor_img_add">
				...
				<?php do_action( 'before_wcmp_vendor_information', $vendor_id ); ?>
					...
					if ( ! empty( $email ) && 'Enable' != $vendor_hide_email ) {
						?>
						<a href="mailto:<?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?>" class="wcmp_vendor_detail"><i class="w-icon-envelope"></i><?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?></a><?php } ?>
					<?php
		...
		<div class="vendor_description">
			<div class="vendor_img_add">
				...
				<div class="wcmp_vendor_defail_wrap">
					...
					if ( ! empty( $email ) && 'Enable' != $vendor_hide_email ) {
						?>
						<a href="mailto:<?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?>" class="wcmp_vendor_detail"><i class="w-icon-envelope"></i><?php echo apply_filters( 'vendor_shop_page_email', $email, $vendor_id ); ?></a>
					<?php } ?>
