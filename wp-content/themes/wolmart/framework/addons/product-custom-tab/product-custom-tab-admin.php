	...
	class Wolmart_Product_Custom_Tab_Admin {
		...
		public function save_product_tabs() {
			...
			if ( ! $custom_tab ) {
				...
				update_post_meta( $post_id, 'wolmart_custom_tab_title_1st', $custom_tab[0] );
				update_post_meta( $post_id, 'wolmart_custom_tab_content_1st', $custom_tab[1] );
			}
			...
			if ( ! $custom_tab ) {
				...
				update_post_meta( $post_id, 'wolmart_custom_tab_title_2nd', $custom_tab[0] );
				update_post_meta( $post_id, 'wolmart_custom_tab_content_2nd', $custom_tab[1] );
			}
