...
if ( $max_value && $min_value === $max_value ) {
	...
	<div class="quantity-wrapper">
		...
		<div class="quantity">
			...
			<button class="quantity-minus w-icon-minus" title="<?php esc_attr_e( 'Minus', 'wolmart' ); ?>"></button>
			<button class="quantity-plus w-icon-plus" title="<?php esc_attr_e( 'Plus', 'wolmart' ); ?>"></button>
