						...
						<td class="product-add-to-cart">
							<div class="d-lg-flex">
								...
								if ( ! is_array( $show_info ) || in_array( 'quickview', $show_info ) ) {
									echo '<button class="btn btn-quickview btn-outline btn-default btn-rounded btn-sm mr-lg-2" data-product="' . $product->get_id() . '" title="' . esc_html__( 'Quick View', 'wolmart' ) . '">' . esc_html__( 'Quick View', 'wolmart' ) . '</button>';
								}
								?>
