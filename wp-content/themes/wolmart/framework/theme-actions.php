...
if ( ! function_exists( 'wolmart_comment_form_args' ) ) {
	...
	function wolmart_comment_form_args( $args ) {
		...
		$args['submit_button']  = '<button type="submit" class="btn btn-dark btn-submit">' .
			( wolmart_is_product() ? esc_html__( 'Submit Review', 'wolmart' ) : esc_html__( 'Post Comment', 'wolmart' ) . ' <i class=" w-icon-long-arrow-right"></i>' ) . '</button>';
		...
		if ( ( $is_facebook_login || $is_google_login || $is_twitter_login ) ) {
			...
			<div class="social-login title-center title-cross text-center">
				...
				<?php if ( $is_google_login ) { ?>
					<a class="social-icon framed rounded social-google" href="<?php echo wp_login_url(); ?>?loginGoogle=1&redirect=<?php echo the_permalink(); ?>" onclick="window.location.href = '<?php echo wp_login_url(); ?>?loginGoogle=1&redirect='+window.location.href; return false">
						<i class="fab fa-google"></i></a>
				<?php } ?>
				<?php if ( $is_facebook_login ) { ?>
					<a class="social-icon framed rounded social-facebook" href="<?php echo wp_login_url(); ?>?loginFacebook=1&redirect=<?php echo the_permalink(); ?>" onclick="window.location.href = '<?php echo wp_login_url(); ?>?loginFacebook=1&redirect='+window.location.href; return false"><i class="fab fa-facebook-f"></i></a>
				<?php } ?>
				<?php if ( $is_twitter_login ) { ?>
					<a class="social-icon framed rounded social-twitter" href="<?php echo wp_login_url(); ?>?loginSocial=twitter&redirect=<?php echo the_permalink(); ?>" onclick="window.location.href = '<?php echo wp_login_url(); ?>?loginSocial=twitter&redirect='+window.location.href; return false">
