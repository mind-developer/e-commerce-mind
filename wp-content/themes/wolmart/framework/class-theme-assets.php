...
class Wolmart_Theme_Assets extends Wolmart_Base {
	...
	public function register_scripts() {
		...
		wp_register_style( 'animate', WOLMART_ASSETS . '/vendor/animate/animate.min.css' );
		...
		wp_register_script( 'jquery-cookie', WOLMART_ASSETS . '/vendor/jquery.cookie/jquery.cookie' . $suffix, array(), '1.4.1', true );
		...
		if ( ! defined( 'ELEMENTOR_VERSION' ) ) {
			wp_register_script( 'swiper', WOLMART_ASSETS . '/vendor/swiper/swiper' . $suffix, '6.7.0', true );
		}
	}
