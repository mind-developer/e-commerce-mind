...
class Wolmart_WCMP extends Wolmart_Base {
	...
	public function __construct() {
		...
		add_action( 'wolmart_eqnueue_product_widget_related_scripts', array( $this, 'enqueue_wcmp_product_scripts' ) );
	...
	public function vendor_store_tab_start() {
		...
		<div class="tab tab-nav-boxed tab-nav-underline tab-nav-sm-center">
			<ul class="nav nav-tabs">
				<li class="nav-item"><a class="nav-link active" href="#vendor-products"><?php echo esc_html__( 'Products', 'wolmart' ); ?></a></li>
				<li class="nav-item"><a class="nav-link" href="#vendor-reviews"><?php echo esc_html__( 'Reviews', 'wolmart' ); ?></a></li>
			</ul>
