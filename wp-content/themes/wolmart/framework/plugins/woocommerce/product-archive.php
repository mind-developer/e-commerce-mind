...
add_filter( 'woocommerce_layered_nav_count', 'wolmart_woo_layered_nav_count' );
...
if ( ! function_exists( 'wolmart_wc_shop_show_type' ) ) {
	function wolmart_wc_shop_show_type() {
		...
		<div class="toolbox-item toolbox-show-type">
			<a href="<?php echo esc_url( wolmart_add_url_parameters( $cur_url, 'showtype', 'grid' ) ); ?>" class="w-icon-grid btn-showtype<?php echo boolval( $is_list_type ) ? '' : ' active'; ?>"></a>
			<a href="<?php echo esc_url( wolmart_add_url_parameters( $cur_url, 'showtype', 'list' ) ); ?>" class="w-icon-list btn-showtype<?php echo boolval( $is_list_type ) ? ' active' : ''; ?>"></a>
		</div>
		<?php
...
if ( ! function_exists( 'wolmart_woo_layered_nav_count' ) ) {
	function wolmart_woo_layered_nav_count() {
		return '';
	}
}
