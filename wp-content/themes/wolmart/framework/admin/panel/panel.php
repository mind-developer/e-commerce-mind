	...
	public function add_admin_menus() {
		...
		if ( current_user_can( 'edit_theme_options' ) ) {
			...
			if ( class_exists( 'Wolmart_Layout_Builder_Admin' ) ) {
				add_submenu_page( 'wolmart', esc_html__( 'Layout Builder', 'wolmart' ), esc_html__( 'Layout Builder', 'wolmart' ), 'manage_options', 'wolmart-layout-builder', array( Wolmart_Layout_Builder_Admin::get_instance(), 'view_layout_builder' ), 2 );
			} else {
				add_submenu_page( 'wolmart', esc_html__( 'Layout Builder', 'wolmart' ), esc_html__( 'Layout Builder', 'wolmart' ), 'manage_options', 'admin.php?page=wolmart-layout-builder', '', 2 );
			}
		}
	}
