	...
	<div class="wolmart-admin-panel-row">
		<div class="wolmart-admin-panel-side">
			<div class="wolmart-card-box wolmart-version">
				...
				<h3><?php printf( esc_html__( '%1$sWolmart eCommerce%2$sversion %3$s', 'wolmart' ), '<b>', '</b><br>', WOLMART_VERSION ); ?></h3>
			</div>
		</div>
				...
				<div class="wolmart-important-notice registration-form-container">
					<div class="wolmart-registration-form">
						...
						<ul>
							...
							<li><i class="circle fa fa-check"></i><?php printf( esc_html__( 'Please go to %1$sThemeForest.net/downloads%2$s', 'wolmart' ), '<a target="_blank" href="https://themeforest.net/downloads">', '</a>' ); ?></li>
							<li><i class="circle fa fa-check"></i><?php printf( esc_html__( 'Click the Download button in Wolmart row', 'wolmart' ), '<strong>', '</strong>' ); ?></li>
							<li><i class="circle fa fa-check"></i><?php printf( esc_html__( 'Select License Certificate & Purchase code', 'wolmart' ), '<strong>', '</strong>' ); ?></li>
							<li><i class="circle fa fa-check"></i><?php printf( esc_html__( 'Copy Item Purchase Code', 'wolmart' ), '<strong>', '</strong>' ); ?></li>
						</ul>
