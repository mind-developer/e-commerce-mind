...
class Wolmart_Version_Control extends Wolmart_Base {
	...
	public function add_admin_menu() {
		add_submenu_page( 'wolmart', esc_html__( 'Version Control', 'wolmart' ), esc_html__( 'Version Control', 'wolmart' ), 'manage_options', $this->page_slug, array( $this, 'view_tools' ), 2 );
	}
				...
				<tbody id="the-list">
					<tr class="theme-version" id="wolmart-theme-version">
						...
						<td class="run-tool">
							...
							<a href="#" class="button button-large button-light theme-rollback"><?php echo esc_html__( 'Downgrade', 'wolmart' ); ?></a>
						</td>
					</tr>
					<tr class="plugin-version" id="wolmart-plugin-version">
						...
						<td class="run-tool">
							...
							<a href="#" class="button button-large button-light plugin-rollback"><?php echo esc_html__( 'Downgrade', 'wolmart' ); ?></a>
						</td>
					</tr>
				</tbody>
			</table>
