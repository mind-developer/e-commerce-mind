...
<div class="wolmart-admin-panel-row">
	<div class="wolmart-support">
		...
		<h4 class="success system-status"><i class="circle fa fa-check"></i> <?php printf( esc_html__( 'Item Support %1$sDOES%2$s Include:', 'wolmart' ), '<strong class="success">', '</strong>' ); ?></h4>
	...
	<div class="wolmart-support">
		<?php /* translators: $1 and $2 opening and closing strong tags respectively */ ?>
		<h4 class="error system-status"><i class="circle fas fa-ban"></i> <?php printf( esc_html__( 'Item Support %1$sDOES NOT%2$s Include:', 'wolmart' ), '<strong class="error">', '</strong>' ); ?></h4>
		<ul class="list">
